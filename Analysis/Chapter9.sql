...
SELECT est_number,
       ...
       zip
FROM meat_poultry_egg_inspect
WHERE (city = 'Blaine');--not complete
...
COPY state_regions FROM 'C:\Users\Sean\OneDrive - Reboss\Desktop\PostgresSQL - Copy\SQL\Analysis\state_regions.csv' WITH (FORMAT CSV, HEADER, DELIMITER ',');
